...
function NormalGearFactory () {
    this.rngUtils = new RNGUtils();
}

NormalGearFactory.prototype.getItemForPlayer = function (player_level) {
    var addToLevel = 0;
    if (this.rngUtils.getRandom(50, 52) == 51) {
        addToLevel = this.rngUtils.getRandom(0, 4);
    }
    ...
    switch (player_level) {
        ...
        case 6:
        case 7:
            var rng = this.rngUtils.getRandom(1, 4);
            if (rng == 2) {
...
NormalGearFactory.prototype.getFirstTierItem = function () {
    var rng = this.rngUtils.getRandom(1, 4);
    switch(rng) {
        case 1:
            return new Dagger();
